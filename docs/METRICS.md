...
- `src/metrics_builtins.c` - Lisp builtins
- `src/metrics_delta.c` - Delta computation for streaming
- `src/aio/aio_metrics.c`, `src/aio/aio_metrics_v2.c` - AIO metrics
- `src/event_loop_metrics.c` - Event loop instrumentation
- `src/pool_metrics.c` - Pool/slab metrics
