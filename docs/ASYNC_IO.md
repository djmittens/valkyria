...
- `src/aio/` - Async I/O subsystem
- `src/aio/aio_uv.c` - libuv backend
- `src/aio/aio_async.c` - Handles and combinators
- `src/aio/http2/` - HTTP/2 client, server, sessions
- `src/aio/http2/aio_ssl.c` - TLS
