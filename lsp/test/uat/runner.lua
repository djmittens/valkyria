...
--
--     nvim --headless -l <abs>/lsp/test/uat/runner.lua
--
-- It is not invoked by hand. testing/run-tests.valk discovers
...
-- discover-uat-tests).
--
-- Contract with testing/run-tests.valk (run-one-suite / parse-jsonl-tests):
--   stdout    one JSON object per line, {"test","status","us","suite"} —
--             the same schema testing/c/testing.c and testing/test.valk emit
...
-- kind="end" value (lsp/scan.valk:142-148). Record that so scenarios
